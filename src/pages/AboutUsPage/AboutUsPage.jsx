...
const AboutUsPage = () => {
    return (
      <div className='AboutUs'>
          ...
          &nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
          <a className="article" href="https://www.psychologytoday.com/blog/canine-corner/201106/can-dogs-help-humans-heal" target="_blank">Click here to read a small article!</a>
          &nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
